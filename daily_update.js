...
function runDownstream() {
  ...
  for (const script of ['reproc.js', 'tomorrow_active.js', 'add_industry.js', 'add_sub_industry.js', 'render_html.js', 'render_home.js', 'build_analysis.js', 'build_screener.js']) {
